 ...
 * @return void 
 */
void termCmd(); //Função destinada a terminar a operação da psh após ter matado todos os processos que foram criados (vacinados e não vacinados).
...
/**
 * @brief Seta o mesmo gpid (grupo de pid) para comandos do tipo Vacinados.
 * 
 * @param lst 
 * @param pid_t 
 * @return void
...
/**
 * @brief  Tratamento da saída direcionada para um arquivo (existente)
 * 
 * @param char** 
 * @param int 
 * @return int
